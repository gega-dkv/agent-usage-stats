...
export function Sidebar({
  ...
  const { data: scan } = useQuery<ScanStatus>('scan-status', {
    fetcher: () => fetchJson<ScanStatus>('/api/scan'),
  });
    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'md:sticky md:top-0 md:h-full md:shrink-0 md:translate-x-0',
      ...
      >
        ...
        <div className="flex h-16 items-center gap-2.5 border-b border-sidebar-border px-4">
          <Link to="/" className="flex min-w-0 items-center gap-2.5" onClick={onMobileClose}>
